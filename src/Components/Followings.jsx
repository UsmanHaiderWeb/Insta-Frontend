...
return (
    <div className='w-full flex justify-start items-center flex-col mt-10'>
        <h1 className='text-[18px] font-semibold tracking-wider'>Followings</h1>
        <div className='w-full flex justify-center items-center flex-wrap gap-y-0 gap-x-2 mt-3 border-t pt-5'>
            {allFollowings.map((user, udx) => (
                <div key={`${user._id}, ${Math.random() * 122345444899}`} className='w-[350px] xl:w-[300px] max-w-[350px] md:w-full sm:w-[400px] mobile:w-[90%] micro:w-[95%] flex justify-between items-center flex-wrap mb-3 px-2 pt-2'>
